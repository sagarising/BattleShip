...
var setPlayerCookie = function(req,res) {
	...
	res.cookie('gameId', req.body.gameId||app.observer.games[app.observer.games.length-1].gameID);
};
// app.use(app.router);
...
app.post('/player',function(req,res){
	if(!req.body.gameId)
		...
		app.observer.allocatePlayerToSpecificGame(req.body.name,new Grid(),req.body.gameId);
